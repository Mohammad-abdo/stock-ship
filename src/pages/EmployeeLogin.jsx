      ...
      >
        <Card className="shadow-2xl border-0 backdrop-blur-sm bg-card/95">
          <CardHeader className="space-y-1 text-center pb-8">
            ...
            <CardTitle className="text-2xl font-bold bg-linear-to-r from-green-500 to-green-600 bg-clip-text text-transparent">
          ...
          <CardContent>
            ...
            >
              <button
                onClick={() => navigate("/")}
                className="text-green-500 hover:text-green-600 font-medium transition-colors inline-flex items-center gap-2"
              >
                <svg
                  width="16"
                  height="16"
