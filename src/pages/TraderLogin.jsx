...
export default function TraderLogin() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const result = await login(email, password, "trader", rememberMe);
              ...
              >
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    required
                    className="w-full pl-10 pr-12 py-3 rounded-lg border border-input bg-background focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-all"
                    placeholder="••••••••"
                  />
